...
// Rï¿½cupï¿½rer la date de début de l'établissement depuis la table ETABLISSEMENT
...
// Fonction pour extraire la DERNIRE période d'une chaine de périodes
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <a href="agtrecherchepay.php" class="btn btn-black btn-sm">
                    <i class="bi bi-arrow-left me-2"></i>Retour
                </a>
                <div class="text-center">
                    <a href="agtrecherchepay.php">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-bold">
                            ...
                            MONTANT PAYE (Frs) <span class="text-danger">*</span>
                        </label>
                    ...
                    <div class="col-12">
                        ...
                        <div class="radio-group">
                            <div class="radio-option" onclick="selectMode('ESPECE')">
                                ...
                                <label for="espece">
                                    <i class="bi bi-cash text-success me-1"></i>ESPECE
                                </label>
                            </div>
                            <div class="radio-option" onclick="selectMode('CHEQUE')">
                                <input type="radio" name="modepay" id="cheque" value="CHEQUE" 
                                       onchange="toggleReference()">
                                <label for="cheque">
                                    <i class="bi bi-bank text-primary me-1"></i>CHEQUE
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-bold">
                            ...
                            PERIODE PAYEE <span class="text-danger">*</span>
                        </label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <div class="text-start">
                    ...
                    <p><strong>Période payée :</strong> <?= htmlspecialchars($_SESSION['periode']) ?></p>
                    <p><strong>Mode de paiement:</strong> <?= htmlspecialchars($_SESSION['modepay']) ?></p>
                    <p><strong>Date de paiment :</strong> <?= htmlspecialchars($_SESSION['datepay']) ?></p>
                </div>
            </div>
            <div class="modal-footer justify-content-center">
                <a href="agtrecherchepay.php" class="btn btn-orange btn-lg px-4">
...
<script>
        ...
        if (periodes.length === 0) {
            ...
            if (hasSolde && resteAPayer > 0) {
                ...
                if (nbMoisCompletsApres > 0) {
                    description = '<span class="text-success">Solde du mois prï¿½cï¿½dent + ' + nbMoisCompletsApres + ' mois complet' + (nbMoisCompletsApres > 1 ? 's' : '') + '</span>';
                    info = '<i class="bi bi-check-circle text-success me-1"></i>Solde + ' + nbMoisCompletsApres + ' mois';
                } else {
                    description = '<span class="text-success">Solde du mois prï¿½cï¿½dent</span>';
                    info = '<i class="bi bi-check-circle text-success me-1"></i>Solde du mois';
                }
            } else {
    ...
    function calculerPeriodeAuto() {
        ...
        if (montant === 0 || isNaN(montant)) {
            periodeInput.value = '';
            infoMois.innerHTML = '';
            periodeDescription.textContent = 'La pï¿½riode sera calculï¿½e automatiquement';
            return;
        }
