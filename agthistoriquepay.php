        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr>
                            <th><i class="bi bi-calendar-range me-1"></i>PERIODES PAYEES</th>
                            <th><i class="bi bi-receipt me-1"></i>N QUITTANCE</th>
                            <th><i class="bi bi-cash-coin me-1"></i>MONTANT PAYE</th>
                            <th><i class="bi bi-credit-card me-1"></i>MODE DE PAIEMENT</th>
                            <th><i class="bi bi-hash me-1"></i>REFERENCE PAIEMENT</th>
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="d-flex justify-content-between flex-wrap">
                        <div class="btn-group">
                            <a href="agtrecherchepay.php" class="btn btn-black">
                                <i class="bi bi-arrow-left me-2"></i>Retour à la liste
                            </a>
                            <a href="paynormal.php?affichclient=<?= $_GET['affichclient'] ?>" 
...
<script>
    function exportToExcel() {
        // Simple export Excel (0 améliorer selon vos besoins)
